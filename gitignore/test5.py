...
if __name__ == "__main__":
    ...
    window.grid_columnconfigure(1, weight=1) # Centralizando a barra de pesquisa na horizontal
    ...
    button_search.grid(row=0, column=2, padx=(180,0))  # Adicionando algum espaço entre a entrada e o botão
